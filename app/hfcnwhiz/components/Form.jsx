...
const Form = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "Horsefirecapsule.com/HFCNWHIZ")
            formdata.append("ip", check ? check : "")
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked)
            formdata.append("blog_url", process.env.NEXT_APP_URL_HFCNWHIZ ?? "horsefirecapsule.com/hfcnwhiz")
    ...
    return (
        <div id="form" >
            ...
            <div className="mx-auto fontNoto  bg-zinc-800  px-4 py-6 border rounded-lg " id='formcallhide'>
                <div>
                    <h1 className="fontPoppins text-4xl font-bold inline-block border-bottom text-white border-b-4 border-sky-500"> Contact Us </h1>
