...
const Form = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "Horsefirecapsule.com/HFCSTORY1")
            formdata.append("ip", check ? check : "")
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked)
            formdata.append("blog_url", process.env.NEXT_APP_URL_HFCSTORY1 ?? "horsefirecapsule.com/hfcstoy1")
            ...
            <div className="header_background">
                ...
                >
                    <div className="max-w-6xl mx-auto py-9 md:py-24 px-3">
                        ...
                        <h1 className="fontNoto text-3xl md:text-4xl text-black text-center fw-bold mb-6 md:mb-12 font-extrabold">कॉल पर विशेषज्ञ से मुफ्त सलाह के लिए फॉर्म भरें!</h1>
                        <div className="grid grid-cols-12 m-0 gap-6 items-center">
                            <div className="col-span-12 md:col-span-6 fontPoppins text-black font-nunito mt-1 md:mt-0 order-2 sm:order-1">
                                <h1 className="text-xl fontNoto text-justify font-bold md:text-2xl">तो देर किस बात की यौन जीवन में खुशहाली की तरफ अपना पहला कदम बढ़ाएं!</h1>

                                <hr className="border-t-2 my-3 md:my-6  opacity-100" />

                                <h1 className=" font-bold text-xl md:text-3xl leading-normal">Get free advice from experts</h1>
                                <div className="form_shaddow md:text-2xl fontKalnia  text-md font-bold md:mt-5 mt-3 text-black bg-[#f9d830] px-4 rounded-xl inline-block">
                                        ...
                                        <div>
                                            ...
                                            <form className="space-y-3">
                                                ...
                                                <div className="flex justify-center items-center pt-4 ">
                                                    <button onClick={handleFormSubmit} type="button" className="bg-red-600 text-xl font-bold p-3 pt-3 md:w-72 w-full rounded-md hover:bg-slate-700 transition-colors text-white">
                                                        SUBMIT
                                                    </button>
                                                </div>
                                            </form>
