...
const Form = () => {
    ...
    const { CustomerData, setCustomerData, checkoutDetail, setLoading, loading, hours, minutes, remainingSeconds, openPopup } = useGlobalContext();
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "Horsefirecapsule.com/HFCLUM")
            formdata.append("ip", check ? check : "")
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked)
            formdata.append("blog_url", process.env.NEXT_APP_URL_HFCLUM ?? "horsefirecapsule.com/hfclum")
                        ...
                        <div className=" ">
                            ...
                            <div className="grid grid-cols-12 items-center font-bold text-2xl sm:text-[2.15rem] leading-tight">
                                <div className="col-span-8">
                                    <h1 className="commonhft ">Horse Fire Capsule</h1>
