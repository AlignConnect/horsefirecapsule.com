...
const Section5 = () => {
    ...
    return (
        <div className='w-full py-2 md:py-5 px-3 '>
            ...
            <p className="text-justify text-xl md:text-2xl max-w-5xl mx-auto  mb-3 md:mb-0">"हॉर्सफायर कैप्सूल" सेक्स अवधि, लिंग की लम्बाई-मोटाई और सख्ती बढ़ाने के साथ जोश और सेक्स इच्छा को उच्चतम स्तर पर पंहुचा कर महिला पार्टनर को चरमसुख से भेंट कराने की सबसे बेहतरीन फार्मूला है। आयुर्वेदिक इतिहास की 17 सबसे असरदार और विश्वसनीय जड़ीबूटियों से बना यह प्रोडक्ट पुरुष यौन समस्या को जड़ से उखाड़ फेंकने में सक्षम है।</p>
            ...
            <div className="w-full max-w-6xl mx-auto mt-5 md:mt-0">
                ...
                <div className="border-2 border-black py-2 px-2">
                    <p className='fontNoto text-xl md:text-2xl text-justify px-1 pb-1 md:py-5'>
                        <span style={{ color: "red", fontWeight: "700" }}>"Horse Fire Capsule"</span> आयुष मंत्रालय भारत सरकार के सभी नियम और मापदंडो को अनुसरण कर तैयार किया गया है। यह सभी लैब परिक्षण में सफल हुआ और इस पर श्रेष्ठ यौनवर्धक और लिंग वर्धक सूत्रीकरण का मुहर लग गया। साल 2018 से यह यौन वर्धक श्रेणी में प्रथम स्थान पर काबिज है और लगातार बेहतरी के साथ पुरुष यौन कमजोरी को दूर कर उनके जीवन में खुशिया लौटा रहा है।
                    </p>
                ...
                <img
                    ...
                    src={"/checkout_images/flippro.webp"}
                    alt='expert_aword'
                    loading="lazy"
                />
            </div>
