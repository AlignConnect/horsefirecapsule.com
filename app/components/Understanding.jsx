...
const Understanding = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "Horsefirecapsule.com");
            formdata.append("ip", check ? check : "");
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked);
            formdata.append("blog_url", process.env.NEXT_APP_URL ?? "horsefireCapsule.com");
    ...
    return (
        <div> <div className="max-w-3xl mx-auto px-3">
            ...
            <p className="text-xl text-justify">
                Horse Fire Capsule की मदद से अपनी शीघ्रपतन, लिंग में ढीलापन, छोटापन,
            ...
            <div className="bg-yellow-400 p-4 rounded-lg ring-2 ring-yellow-300 ring-offset-4">
                ...
                <p className="text-xl font-bold text-justify md:text-center">
                    ...
                    Horse fire Capsule कस्टमाइज्ड भी तैयार किया जाता है जिससे यह समस्या
                    पर सटीक असर करता है।
                </p>
            </div>
            ...
            <h1 className="text-center bg-red-500 pb-3 pt-6 mt-4 text-white font-bold text-3xl md:text-4xl leading-wide">
                Horse Fire Capsule पर कस्टमर की राय
            </h1>
