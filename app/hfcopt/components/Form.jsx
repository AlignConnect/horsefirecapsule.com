...
const Form = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "Horsefirecapsule.com/HFCOPT");
            formdata.append("ip", check ? check : "");
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked);
            formdata.append("blog_url", process.env.NEXT_APP_URL_HFCOPT ?? "horsefirecapsule.com/hfcopt");
    ...
    return (
        ...
        <section>
            ...
            <div className="pt-3 pb-5 bg-white" id="form">

                <h1 className="text-xl fontArya md:text-3xl text-center font-bold px-2 pb-3"><div className=" max-w-xl mx-auto">कॉल पर विशेषज्ञ डॉक्टरों से मुफ्त सलाह के लिए फॉर्म भरें !</div></h1>

                <div className={`pb-4 fontPoppins text-black ${poppin.className}`} id='formcallhide'>
                    <div className="max-w-2xl mx-4 md:mx-auto rounded-lg  bg-gray-100 p-3 border border-black ">
                        <div className="py-4">
