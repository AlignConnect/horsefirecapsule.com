const FlipAmazon = () => {
    return (
        <section className='max-w-xl mx-auto'>
            <div className="p-0 bg-white w-100 my-2">

                <h5 className="purchaseProduct leading-tight text-center py-1 mb-0">HORSEFIRE CAPSULE खरीदने के लिए निचे क्लिक करें</h5>
