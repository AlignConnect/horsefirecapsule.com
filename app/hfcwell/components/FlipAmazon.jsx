const FlipAmazon = () => {
    return (
        <section className='max-w-3xl mx-auto'>
            <div className="py-1 bg-inherit w-100">

                <h5 className="purchaseProduct leading-tight text-center pt-1 mb-0">HORSEFIRE CAPSULE खरीदने के लिए निचे क्लिक करें</h5>
                <div className="grid grid-cols-1 items-center justify-center gap-1 pb-1">
                    <div className="">
