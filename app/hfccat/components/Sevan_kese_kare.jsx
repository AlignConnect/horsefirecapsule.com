            ...
            <div className=' w-full max-w-6xl mx-auto'>
                ...
                <div className=' py-7'>
                    ...
                    <div className="text-black text-justify fontNoto text-[1.2rem] md:text-xl py-2 px-2">
                        इसका इस्तेमाल बहुत ही सरल है। इसे सुबह और रात के भोजन पश्चात 1 कैप्सूल 1 गिलास गुनगुने पानी/दूध के साथ लेना है। रिसर्च में पाया गया की इसकी प्रभावशीलता दूध के सेवन के साथ बढ़ रही है इसलिए बेहतर परिणाम के लिए हम दूध के साथ सेवन करनी की सलाह देते है।
                    </div>
                                    ...
                                    <div className="fontNoto text-[1.1rem] md:text-2xl my-3 px-2 font-semibold text-justify">
                                        {
                                            aese_kare_sevan([
                                                {
                                                    title: "सुबह-शाम 1 कैप्सूल 1 गिलास गुनगुने दूध के साथ।"
                                                },
                                                {
