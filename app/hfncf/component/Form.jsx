...
const Form = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "HorsefireCapsule.com/HFNCF")
            formdata.append("ip", check ? check : "")
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked)
            formdata.append("blog_url", process.env.NEXT_APP_URL_HFNCF ?? "horsefirecapsule.com/hfncf")
    ...
    return (
        <div id="form" className={`${noto.className} w-full md:w-[600px] mx-auto p-3`}>
            ...
            <div className="mx-auto fontNoto bg-white px-4 py-6 border rounded-lg border border-black" id='formcallhide'>
                <div>
